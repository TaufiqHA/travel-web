...
class DestinationsFactory extends Factory
{
    ...
    {
        $tourTypes = ['Cultural & Sightseeing', 'Beach & Adventure', 'Beach & Culture', 'Nature Exploration', 'Mountain Trekking', 'City Explorer'];
        ...
        return [
            ...
            'pricing' => 'Rp '.number_format(fake()->numberBetween(1000, 25000) * 1000, 0, ',', '.'),
