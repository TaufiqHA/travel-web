...
<head>
    ...
    @hasSection('seo')
        @yield('seo')
    @else
        <title>ToursTravel - Discover Amazing Destinations in Indonesia</title>
        <meta name="description" content="Explore Indonesia and beyond with ToursTravel. Curated destinations, expert guides, and unforgettable experiences await.">
    @endif
