...
@section('title', 'Tour Destinations - ToursTravel Indonesia')
...
<section class="tt-page-hero">
	...
	<div class="container" data-aos="fade-up">
		...
		<h1 class="tt-page-title">Temukan Keindahan <span class="accent">Indonesia</span></h1>
		<p class="tt-page-subtitle">
			Dari pegunungan indah di Bromo hingga terumbu karang menakjubkan di Raja Ampat,
			jelajahi destinasi pilihan kami yang menampilkan keindahan alam Indonesia.
		</p>
	</div>
</section>
					...
					<div class="col-lg-3">
						<div class="tt-form-group">
							...
							<select class="tt-select" name="price_range">
								...
								<option value="0-5000000" {{ request('price_range') == '0-5000000' ? 'selected' : '' }}>Di bawah Rp 5.000.000</option>
								<option value="5000000-10000000" {{ request('price_range') == '5000000-10000000' ? 'selected' : '' }}>Rp 5.000.000 - 10.000.000</option>
								<option value="10000000-20000000" {{ request('price_range') == '10000000-20000000' ? 'selected' : '' }}>Rp 10.000.000 - 20.000.000</option>
								<option value="20000000+" {{ request('price_range') == '20000000+' ? 'selected' : '' }}>Di atas Rp 20.000.000</option>
							</select>
						</div>
					</div>
					<div class="col-lg-2">
		...
		<div class="tt-section-header text-center" data-aos="fade-up">
			...
			<p class="tt-subtitle">
				@if($destinations->count() > 0)
					Showing {{ $destinations->count() }} amazing Indonesian destinations
				@else
