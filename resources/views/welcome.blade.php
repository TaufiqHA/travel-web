	...
	<div class="container tt-hero-content">
		<div class="row align-items-center">
			<div class="col-lg-7" data-aos="fade-right">
				<div class="tt-badge">
					<span>🇮🇩</span>
					<span>Authentic Indonesian Experiences</span>
				</div>

				<h1 class="tt-hero-title">
					Discover the Soul of <span class="accent">Indonesia</span>
				</h1>

				<p class="tt-hero-text">
					Embark on extraordinary journeys through Indonesia's tropical wilderness,
				...
				<div class="tt-hero-actions">
					...
					<a href="{{ route('contact') }}" class="btn-tt-outline-white">
						Plan Your Exploration <i class="fas fa-compass"></i>
					</a>
				</div>
			...
			<div class="col-lg-5 d-none d-lg-block" data-aos="fade-left" data-aos-delay="200">
				<div class="tt-hero-card">
					<img src="{{ asset('images/place-1.jpg') }}" alt="Pesona Indonesia" loading="eager">
					<div class="tt-hero-card-body">
						<span class="card-badge">Popular Choice</span>
						<h4>Bromo & Bali Adventure</h4>
						...
						<div class="tt-hero-card-footer">
							<div>
								...
								<div class="price-value">Rp 8.900.000</div>
							</div>
...
<section class="tt-section">
	<div class="container">
		<div class="tt-section-header text-center" data-aos="fade-up">
			...
			<p class="tt-subtitle">
				Explore Indonesia's most captivating locations, curated by our local experts
		...
		<div class="tt-dest-grid">
			...
			<article class="tt-dest-card" data-aos="fade-up" data-aos-delay="{{ $loop->iteration * 100 }}">
				<div class="tt-dest-card-img">
					...
					<span class="badge-cat">{{ $destination->category->name ?? 'Eksplorasi' }}</span>
				</div>
		...
		<div class="text-center mt-5" data-aos="fade-up">
			<a href="{{ route('packages') }}" class="btn-tt-primary">
				View All Destinations <i class="fas fa-globe-asia"></i>
			</a>
		</div>
	</div>
</section>
		...
		<div class="row align-items-center g-5">
			<div class="col-lg-6" data-aos="fade-right">
				<div class="tt-features-img">
					<img src="{{ asset('images/about.jpg') }}" alt="Pesona Indonesia">
			...
			<div class="col-lg-6" data-aos="fade-left">
				<div class="tt-section-header">
					...
					<h2 class="tt-title">Experience Indonesia with <span class="accent">Local Experts</span></h2>
					<p class="tt-subtitle">
						As proud Indonesians, we don't just show you destinations — we share our homeland with you.
					</p>
				</div>
				...
				<div class="tt-feature-item">
					...
					<div>
						...
						<p>Born and raised in Indonesia, we know every hidden gem, cultural nuance, and breathtaking vista.</p>
					</div>
				</div>
				<div class="tt-feature-item">
				...
				<div class="tt-feature-item">
					...
					<div>
						...
						<p>We partner with local communities and support conservation efforts across Indonesia.</p>
					</div>
				</div>
				<div class="tt-feature-item">
...
<section class="tt-section">
	<div class="container">
		<div class="tt-section-header text-center" data-aos="fade-up">
			...
			<h2 class="tt-title">Stories from the <span class="accent">Nusantara</span></h2>
		</div>
		...
		<div class="tt-testimonials-grid">
			<div class="tt-testimonial-card" data-aos="fade-up" data-aos-delay="100">
				...
				<p class="tt-testimonial-text">
					...
					and made sure every moment was special. The Bromo & Bali tours exceeded all expectations."
				</p>
			...
			<div class="tt-testimonial-card" data-aos="fade-up" data-aos-delay="200">
				...
				<p class="tt-testimonial-text">
					"ToursTravel showed us the real Indonesia. From nature explorations to cultural villages,
...
<section class="tt-cta">
	<div class="container" data-aos="zoom-in">
		...
		<h2>Ready to Begin Your Indonesian Adventure?</h2>
		<p>
			Let our local experts craft your perfect journey. From tropical explorations to coastal escapes,
			cultural immersions to mountain treks — your dream Indonesian experience awaits.
		</p>
