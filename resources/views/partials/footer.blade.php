	...
	<div class="container">
		<div class="row g-4">
			...
			<div class="col-lg-4">
				...
				<p class="mb-3">
					Your trusted local guide to Indonesia's most incredible destinations.
			...
			<div class="col-lg-3 col-md-6">
				<h5>Our Services</h5>
				<a href="#" class="tt-footer-link">Nature Exploration</a>
			...
			<div class="col-lg-3 col-md-6">
				...
				<div class="contact-row">
					...
					<span>Jl. Jend. Sudirman Kav. 21, SCBD<br>Jakarta Selatan, Indonesia</span>
				</div>
				<div class="contact-row">
		...
		<div class="tt-footer-bottom">
			<div class="row align-items-center">
				<div class="col-md-6">
					<p>&copy; {{ date('Y') }} ToursTravel Indonesia. All rights reserved.</p>
				</div>
