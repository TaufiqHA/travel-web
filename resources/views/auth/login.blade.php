...
@section('title', 'Sign In - ToursTravel Indonesia')
    ...
    <div class="tt-auth-card" data-aos="fade-up">
        ...
        <form method="POST" action="{{ route('login') }}" class="tt-form">
            ...
            <div class="text-center my-3">
                <small class="text-muted">New to ToursTravel Indonesia?</small>
            </div>
        ...
        <div class="text-center mt-4">
            <small class="text-muted">&copy; {{ date('Y') }} ToursTravel. Experience Indonesia differently.</small>
        </div>
    </div>
</div>
@endsection