...
@section('title', 'About Us - ToursTravel Indonesia')
...
<section class="tt-page-hero">
	...
	<div class="container" data-aos="fade-up">
		...
		<h1 class="tt-page-title">Discover Indonesia with <span class="accent">Local Experts</span></h1>
		<p class="tt-page-subtitle">
			Born and raised in Indonesia, we share our homeland's beauty, culture,
	...
	<div class="container">
		<div class="row align-items-center g-5">
			<div class="col-lg-6" data-aos="fade-right">
				...
				<h2 class="tt-title mb-3">Born in Indonesia, <span class="accent">Sharing with the World</span></h2>
				<p>
					ToursTravel began as a dream to share Indonesia's incredible beauty with the world.
					As local Indonesians, we know the secret spots, the authentic cultural experiences,
					and the breathtaking landscapes that make our country truly magical.
				</p>
				<p>
					From the majestic peaks of Mount Bromo to the pristine beaches of Bali,
					from Raja Ampat's biodiverse waters to the vibrant streets of Jakarta — we
			...
			<div class="col-lg-6" data-aos="fade-left">
				<div class="tt-about-images">
					<img src="{{ asset('images/about.jpg') }}" alt="Pesona Indonesia" class="img-fluid rounded-3 shadow">
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row g-4">
			<div class="col-lg-6" data-aos="fade-up">
				<div class="tt-mission-card">
					...
					<h3>Our Mission</h3>
					<p>
						To showcase Indonesia's natural wonders and rich cultural heritage through
			...
			<div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
				<div class="tt-mission-card">
					...
					<h3>Our Vision</h3>
					<p>
						To be Indonesia's most trusted and respected tourism company, known for
...
<section class="tt-section">
	<div class="container">
		<div class="tt-section-header text-center" data-aos="fade-up">
			...
			<p class="tt-subtitle">As local Indonesians, we offer authentic experiences you won't find anywhere else.</p>
		</div>
		<div class="row g-4">
			<div class="col-md-6 col-lg-4" data-aos="fade-up">
				<div class="tt-feature-card">
					...
					<p>Experience Indonesia through local eyes with authentic cultural immersion and off-the-beaten-path adventures.</p>
				</div>
			</div>
			...
			<div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
				<div class="tt-feature-card">
					...
					<h4>Expert Guides</h4>
					<p>Our passionate Indonesian guides share stories, traditions, and insights that bring destinations to life.</p>
				</div>
			</div>
			<div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
				<div class="tt-feature-card">
		...
		<div class="row g-4 justify-content-center">
			<div class="col-md-4" data-aos="zoom-in">
				<div class="tt-value-card text-center">
					...
					<p>We're committed to protecting Indonesia's natural beauty and wildlife for future generations through responsible tourism.</p>
				</div>
			</div>
			<div class="col-md-4" data-aos="zoom-in" data-aos-delay="100">
				<div class="tt-value-card text-center">
					...
					<h4>Authenticity</h4>
					<p>Every experience we offer is genuine, connecting you with real Indonesian culture, traditions, and stories.</p>
				</div>
			</div>
...
<section class="tt-stats-banner" data-aos="fade-up">
	<div class="container">
		<h2 class="text-center text-white mb-2">Make Your Indonesia Tour <span class="accent">Memorable & Safe</span></h2>
		<p class="text-center text-white-50 mb-5">Guided thousands of visitors through Indonesia's most incredible experiences.</p>
...
<section class="tt-cta" data-aos="zoom-in">
	<div class="container text-center">
		...
		<h2>Ready to Explore Indonesia?</h2>
		<p>Let our local expertise guide you through an authentic Indonesian adventure.</p>
		<div class="d-flex gap-3 justify-content-center flex-wrap">
			<a href="{{ route('packages') }}" class="btn-tt-white"><i class="fas fa-globe-asia me-2"></i> View Destinations</a>
