...
@section('title', $destinations->title . ' - ToursTravel Indonesia')
		...
		<div class="row g-4">
			...
			<div class="col-lg-4">
				...
				<div class="tt-sidebar-card mb-4" data-aos="fade-left">
					...
					<div class="tt-price-amount">Rp {{ number_format($destinations->price, 0, ',', '.') }}</div>
				...
				<div class="tt-sidebar-card text-center" data-aos="fade-left">
					...
					<a href="tel:+628123456789" class="btn-tt-primary w-100 mb-2"><i class="fas fa-phone me-2"></i> +62 812 3456 789</a>
					<a href="mailto:info@tourstravel.id" class="btn-tt-outline w-100"><i class="fas fa-envelope me-2"></i> Get Quote</a>
				</div>
			</div>
		</div>
	</div>
