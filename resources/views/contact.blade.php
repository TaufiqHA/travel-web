...
@section('title', 'Contact Us - ToursTravel Indonesia')
...
<section class="tt-page-hero">
	...
	<div class="container" data-aos="fade-up">
		...
		<p class="tt-page-subtitle">Siap menjelajahi keindahan Indonesia? Kami di sini untuk membantu Anda merencanakan petualangan yang sempurna.</p>
	</div>
</section>
		...
		<div class="row g-4" data-aos="fade-up">
			<div class="col-md-6 col-lg-3">
				<div class="tt-contact-card text-center">
					...
					<p>Jl. Jend. Sudirman Kav. 21, SCBD<br>Jakarta Selatan, Indonesia</p>
				</div>
			</div>
			<div class="col-md-6 col-lg-3">
				<div class="tt-contact-card text-center">
					...
					<h5>Call Us</h5>
					<p><a href="tel:+628123456789">+62 812 3456 789</a><br>Mon - Sat: 8AM - 6PM</p>
				</div>
			</div>
			<div class="col-md-6 col-lg-3">
				<div class="tt-contact-card text-center">
					...
					<h5>Email Us</h5>
					<p><a href="mailto:info@tourstravel.id">info@tourstravel.id</a><br>We reply within 24 hours</p>
				</div>
			</div>
			<div class="col-md-6 col-lg-3">
				<div class="tt-contact-card text-center">
					...
					<h5>Live Chat</h5>
					<p>Available Mon - Fri<br>9AM - 5PM WIB</p>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="row g-3">
					<div class="col-md-4">
						<div class="tt-contact-card text-center p-3">
							...
							<h6>Easy to Find</h6>
							<small>15 min from Jakarta CBD</small>
						</div>
					</div>
					<div class="col-md-4">
						<div class="tt-contact-card text-center p-3">
			...
			<div class="col-lg-8">
				<div class="accordion tt-accordion" id="faqAccordion" data-aos="fade-up">
					<div class="accordion-item">
						<h2 class="accordion-header"><button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#faq1">How far in advance should I book my tour?</button></h2>
						<div id="faq1" class="accordion-collapse collapse show" data-bs-parent="#faqAccordion">
							<div class="accordion-body">We recommend booking at least 1-3 months in advance, especially for peak holiday seasons. However, we can accommodate last-minute bookings based on availability.</div>
						</div>
					</div>
					<div class="accordion-item">
					...
					<div class="accordion-item">
						...
						<div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
							<div class="accordion-body">Absolutely! We specialize in tailor-made experiences. Contact us with your preferences, budget, and travel dates, and we'll craft the perfect Indonesian adventure.</div>
						</div>
					</div>
					<div class="accordion-item">
...
function initMap() {
	...
	const marker = new google.maps.Marker({ position: loc, map, title: 'ToursTravel Indonesia', animation: google.maps.Animation.DROP });
	const info = new google.maps.InfoWindow({ content: '<div style="padding:.75rem"><strong>ToursTravel Indonesia</strong><br>Jl. Jend. Sudirman Kav. 21, Jakarta<br><span style="color:var(--tt-primary)">+62 812 3456 789</span></div>' });
